...
export function Hero() {
  ...
  const y = prefersReducedMotion ? 0 : 18;
  ...
  const visual: Variants = {
    hidden: { opacity: 0, y: prefersReducedMotion ? 0 : 24, scale: 0.97 },
    visible: {
      opacity: 1,
      y: 0,
      scale: 1,
    ...
    >
      ...
      <Container className="relative grid items-center gap-16 lg:grid-cols-2 lg:gap-12">
        <motion.div initial="hidden" animate="visible" variants={textContainer}>
          ...
          <motion.h1
            variants={item}
            className="mt-6 font-display text-4xl font-semibold leading-[1.05] tracking-tight text-ink sm:text-5xl lg:text-[3.4rem]"
          >
          ...
          <motion.div
            variants={item}
            className="mt-12 flex items-center gap-6 border-t border-line/70 pt-8"
          >
        ...
        >
          ...
          <motion.div
            ...
            animate="visible"
            variants={floatBadge}
            className="absolute -bottom-6 -left-4 flex items-center gap-3 rounded-2xl border border-line bg-background px-5 py-4 shadow-xl shadow-ink/5 sm:-left-8"
          >
