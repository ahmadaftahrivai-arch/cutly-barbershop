...
import { CalendarDays, CheckCircle2, Clock, ListChecks, XCircle } from "lucide-react";
...
export default async function AdminPage({ searchParams }: AdminPageProps) {
  ...
  const [bookings, lookup, total, pending, confirmed, cancelled, today] =
    await Promise.all([
      prisma.booking.findMany({ where, orderBy: { createdAt: "desc" }, take: 100 }),
      buildCatalogLookup(),
